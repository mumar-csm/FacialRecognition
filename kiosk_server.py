...
# The crop-conditioning helpers live in anti_spoof_crop.py so tooling (e.g.
# tools/capture_spoof_samples.py) can reuse the exact same spoof-crop path
# without importing this module (whose body parses argv / loads models).
from anti_spoof_crop import (  # noqa: E402
    FACE_LUMA_MIN, FACE_LUMA_MAX, FACE_CONTRAST_MIN, SPOOF_CROP_INSET,
    _inset_bbox, normalize_face_illumination, assess_face_lighting,
    evaluate_anti_spoof,
)
